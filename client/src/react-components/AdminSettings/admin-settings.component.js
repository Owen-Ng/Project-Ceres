  ...
  constructor(props) {
    ...
    this.state = {
        ...
        */
        ...
        tribeList: {  "Toronto" : ["UofT", "Laurier", "York"],
    ...
    */ 
    showOnPanel(selectedItem, displayType){
        if(displayType === "family"){
            ...
            this.setState({selectedItem: selectedItem, displayType: "family", selectedObj: family})    
        }
    ...
    */
    deleteObj(selectedItem, displayType){
        ...
        if(displayType === "family"){
            ...
            this.setState({ selectedItem: "",selectedObj: [], familyList: newFamilyList, membersLists: updatedList })
        }
        else if (displayType === "store"){
