...
export default class GroceryItem extends Component{
    ...
    handleEdit(e){
        e.preventDefault()
        const newItem = {prevItemName: this.props.name, name: this.state.name, quantity: Number(this.state.quantity)}
    ...
    render() {
        ...
        <div className='GroceryItem-info'>
            ...
            <input 
                ...
                onChange={this.onInputChange}
            />
            <button className="GroceryItem-buttons btn btn-primary">Save</button>
            </form>
        ...
        return (
            <div className="GroceryItem container">
                ...
                <div className="GroceryItem-buttons-container">
                    <button className="GroceryItem-buttons btn btn-secondary btn-edit" onClick={this.changeEditMode}>Edit</button>
                    <button type="button" className="GroceryItem-buttons btn btn-secondary btn-delete" onClick={this.handleDelete}>Delete</button>
                </div>
            }
